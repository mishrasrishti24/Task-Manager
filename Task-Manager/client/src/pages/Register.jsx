            ...
            <div className="w-full max-w-md bg-slate-900/40 backdrop-blur-xl border border-slate-800/80 p-8 rounded-3xl shadow-2xl relative z-10 space-y-6">
                ...
                <div className="text-center space-y-2">
                    ...
                    <p className="text-xs text-slate-400">
                        Join the workspace and start tracking tasks with your team.
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="space-y-1">
                        <label className="text-[10px] uppercase font-semibold text-slate-400 tracking-wider">Username</label>
                        <input
                            type="text"
                            placeholder="johndoe"
                            value={username}
                    ...
                    <div className="space-y-1">
                        <label className="text-[10px] uppercase font-semibold text-slate-400 tracking-wider">Workspace Role</label>
                        <select
                            value={role}
                        ...
                        >
                            ...
                            <option value="Admin">Admin (Create projects, assign tasks, manage members)</option>
                        </select>
                    </div>
